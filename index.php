    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <?php
                    $kategori = $dbo->select('tbkategori');
                ...
                <li><a href="logout.php" class="btn-hapus">Logout</a></li>
</ul>
</nav>
</header>
<?php
...
<section class="menu">
    ...
    <?php
        ...
        if(!empty($_SESSION['cart'])){
            foreach($_SESSION['cart'] as $id=>$val){
                $datamenu = $dbo->select("tbmenu where idmenu=$id");
    ...
    <?php
        if($jumlahpesanan>0){
            ?>
            <a href="checkout.php" class="btn-chekout">checkout</a>
            <?php
        }
    ?>
...
<section class="menu">
    ...
    <?php
        ...
        if($kategori==""){
            $menu = $dbo->select('tbmenu');
        }else{
            $menu = $dbo->select("tbmenu where idkategori=".$kategori);
        }
