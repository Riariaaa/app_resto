<?php
    ...
    if($aksi=='bayar'){
        ...
        $update = $dbo->update("tborders","total= $total,diskon=$diskon,pajak='$pajak',kembali=$kembalian","idorder=".$_GET['idorder']);
        if($update){
            ?>
            <script>
    ...
    <div class="data">
        <table style="width:60%; margin:auto;margin-top:100px" cellspacing="0" cellpadding="0">
            ...
            <?php
                $datamenu = $dbo->select("tborderdetail  a, tbmenu b where a.idmenu = b.idmenu","a.*,b.nama_menu");
                $no=1;
                $total=0;
